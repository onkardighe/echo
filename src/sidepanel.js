...
const PeerConnectionManager_1 = require("./webrtc/PeerConnectionManager");
// UI Elements
...
const localSignalArea = document.getElementById('local-signal');
const remoteSignalArea = document.getElementById('remote-signal');
...
function initPCM() {
    if (pcm)
        return;
    pcm = new PeerConnectionManager_1.PeerConnectionManager((signal) => {
